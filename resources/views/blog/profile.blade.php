    ...
    <div class="stunning-header stunning-header-bg-lightviolet">
        <div class="stunning-header-content">
            ...
            <div class="span3 well">
                @if($user->avatar=='')
                    <a href="/storage/avatar/avatar.webp" class="link-image js-zoom-image">
                        <img src="/storage/avatar/avatar.webp" id="avatar" width="30%" height="30%" class="rounded-circle">
                    </a>
                @else
                    <a href="/storage/{{$user->avatar}}" class="link-image js-zoom-image">
                        <img src="/storage/{{$user->avatar}}" id="avatar" width="30%" height="30%" class="rounded-circle">
                    </a>
                @endif
